...
const TOOL_REQUIRING_KEYWORDS: &[&str] = &[
    "fix", "edit", "change", "modify", "update", "create", "write", "delete",
    "refactor", "implement", "add", "remove", "replace", "rename",
    "run", "test", "build", "compile", "deploy", "install",
...
const LOCAL_FRIENDLY_KEYWORDS: &[&str] = &[
    "what is", "what are", "how does", "explain", "describe", "summarize",
    "compare", "difference between", "meaning of", "definition of",
    "why", "when", "which", "tell me about",
];
...
pub fn should_use_local(
    ...
    let is_friendly = LOCAL_FRIENDLY_KEYWORDS
        .iter()
        .any(|kw| lower.contains(kw));
