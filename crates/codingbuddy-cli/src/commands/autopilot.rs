...
use codingbuddy_core::{AppConfig, EventEnvelope, EventKind, runtime_dir};
use codingbuddy_store::{AutopilotRunRecord, BackgroundJobRecord, Store};
use serde_json::json;
use std::fs;
