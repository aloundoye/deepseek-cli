...
| workflow.slash.mode_aliases | workflow | `/ask /code /architect /chat-mode` switch UX profiles without changing runtime engine | `crates/deepseek-ui/src/lib.rs` parser tests + `crates/deepseek-cli/src/commands/chat.rs` tests |
